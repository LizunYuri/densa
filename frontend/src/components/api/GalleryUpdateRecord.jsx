...
const GalleryUpdateRecord = ({ recordId, onRecordUpdated }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`/gallery/gallery/${recordId}/`);
            if (response.ok) {
    ...
    const readData = async (e) => {
        ...
        try {
            const response = await fetch(`/gallery/update/gallery/${recordId}/`, {
                method: 'PUT',
                body: formData,
            });
...
export default GalleryUpdateRecord;
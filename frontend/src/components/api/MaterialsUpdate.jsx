...
const MaterialsUpdate = ({ recordId, onRecordUpdated }) => {
const [title, setTitle] = useState('')
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`/materials/materials/materials/${recordId}/`);
            if (response.ok) {
    ...
    const readData = async (e) => {
        ...
        try {
            const response = await fetch(`/materials/update/materials/${recordId}/`, {
                method: 'PUT',
                body: formData,
            });

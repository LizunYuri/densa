    ...
    return (
        <div className='dashboard_modal'>
            ...
            {isAuthenticated ? 
                <>
                    <h2>Первый экран</h2>
                    <p>Информация отображается при загрузке страницы. Можно использовать любое количеество элементов. Загружаемое изображение должно быть высокого качества с разрешением не меньше 1920х1080.</p>
